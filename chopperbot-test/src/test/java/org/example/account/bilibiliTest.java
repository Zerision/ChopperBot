...
public class bilibiliTest {
    ...
    public void getcookies() throws Exception {
        ...
        options.setBinary("C:\\Users\\zyc13\\Desktop\\chrome-win64\\chrome.exe");
...
//        获取cookie,再通过baocun函数进行序列化操作
    ...
    public static void baocun(Set<Cookie> cookies) throws Exception {
        ObjectOutputStream objectOutputStream = new ObjectOutputStream(new FileOutputStream("C:\\Users\\zyc13\\Desktop\\1.txt"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        prefs.put("download.default_directory", "C:\\Users\\zyc13\\Desktop\\");
...
//       WangyiUtils.get cookies();
    ...
    public static Set<Cookie> read() throws Exception {
        ObjectInputStream objectInputStream = new ObjectInputStream(new FileInputStream("C:\\Users\\zyc13\\Desktop\\1.txt"));
